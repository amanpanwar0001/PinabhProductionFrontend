      ...
      <div className="carousel-container" >
        <Carousel interval={3000}>
          <Carousel.Item>
            ...
            />
            <Carousel.Caption>
              <h3 className='text' style={{fontSize:"35px",fontWeight:"bold"}}>Capture moments, create legacies.</h3>
          ...
          <Carousel.Item>
            ...
            />
            <Carousel.Caption>
              <h3 className='text'style={{fontSize:"35px",fontWeight:"bold"}}>Dream big, film bigger.</h3>
          ...
          <Carousel.Item>
            ...
            />
            <Carousel.Caption>
              <h3 className='text'style={{fontSize:"35px",fontWeight:"bold"}}>Lights, camera, action</h3>
          ...
          <Carousel.Item>
            ...
            />
            <Carousel.Caption>
              <h3 className='text'style={{fontSize:"35px",fontWeight:"bold"}}>Where creativity meets professionalism</h3>
